<head>
    ...
    <meta charset="UTF-8">
    @stack('title')
    <script src="{{asset('assets/nepali.datepicker.v4.0.1.min.js')}}" type="text/javascript"></script>
    <link href="{{asset('assets/nepali.datepicker.v4.0.1.min.css')}}" rel="stylesheet" type="text/css" />
