        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container rounded-container bg-light">
                    <h2 class=" text-center">Fertilizer Expenses Management System</h2>
                    <p class="text-center mb-3 text-dark h5">Naindra Tea Farm</p><br>
                    <form action="{{url('/admin/fertilizer-expenses/insert')}}" method="post">
                        @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a href="{{url('/admin/fertilizer-expenses/delete/')}}/{{$data->fertilizer_id}}"
